...
export function Footer() {
  return (
    <header className="grid gap-y-6 md:grid-cols-3 grid-cols-1 md:mx-36 mx-4 mt-4 px-8 py-6 bg-neutral-800 rounded-sm border-t border-t-neutral-700">
      <div>
        <h1 className="font-semibold text-base">팀 정보</h1>
        <div className="grid md:mt-4 mt-1 text-sm text-neutral-200">
